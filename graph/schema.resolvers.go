...
import (
	...
	"github.com/SEC-Jobstreet/backend-job-service/database"
...
// CreateSavedJob is the resolver for the createSavedJob field.
func (r *mutationResolver) CreateSavedJob(ctx context.Context, jobID string, candidateID string) (*model.SavedJob, error) {
	return db.CreateSavedJob(jobID, candidateID), nil
}
...
// GetSavedJobs is the resolver for the getSavedJobs field.
func (r *queryResolver) GetSavedJobs(ctx context.Context, candidateID string) ([]*model.JobListing, error) {
	return db.GetSavedJobs(candidateID), nil
}
...
func NewDatabaseConnection(config *utils.Config) {
